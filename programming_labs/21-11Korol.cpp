...
//Питання:
//1. Структура - це об'єднання різних змінних, якому можна присвоїти ім'я
//2. Будь які типи даних та будь які інші структури
//3. При оголошенні шаблону структури 
//4. Це коли одна структура має в своїх полях інші
